      ...
      <section id="clients" className="py-20 px-6 bg-darker">
        <div className="container mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4 neon-text">Ils Me Font Confiance</h2>
            <p className="text-gray-400 text-lg">Fier de travailler avec des marques incroyables</p>
          </motion.div>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8 items-center max-w-7xl mx-auto justify-items-center">
      ...
      <section id="testimonials" className="py-20 px-6">
        <div className="container mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4 neon-text">Avis Clients</h2>
            <p className="text-gray-400 text-lg">Ce que les clients disent de notre collaboration</p>
          </motion.div>
